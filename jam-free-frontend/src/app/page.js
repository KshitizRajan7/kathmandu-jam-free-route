...
export default function Home() {
  ...
  return (
    <>
      ...
      <Homepage resetMap={resetMap} setResetMap={setResetMap} selectedSourceCoords={selectedSourceCoords} selectedDestinationCoords={selectedDestinationCoords} setModalOpen={setModalOpen} />
      <TrafficNotification modalOpen={modalOpen} setOpenTrafficNotifcation={setOpenTrafficNotifcation} openTrafficNotifcation={openTrafficNotifcation} />
      <Menu setResetMap={setResetMap} setSelectedSourceCoords={setSelectedSourceCoords} setSelectedDestinationCoords={setSelectedDestinationCoords} setModalOpen={setModalOpen} modalOpen={modalOpen} />
    </>
